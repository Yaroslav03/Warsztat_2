...
namespace Warsztat_2._0.UserControls.UC_CreateData
{
    public partial class UC_AddClient : UserControl
    {
        ...
        private async Task DeleteData(DataGridViewCellEventArgs e)
        {
            Cursor.Current = Cursors.WaitCursor;

            if (e.ColumnIndex == ViewClients.Columns["BtnDelete"].Index && ViewClients.Rows[e.RowIndex].Cells["ID_Column"].Value != DBNull.Value)
            {
                long idToDelete = (long)ViewClients.Rows[e.RowIndex].Cells["ID_Column"].Value;
                ...
                ViewClients.Rows.RemoveAt(e.RowIndex);
        ...
        {
            if (SetCarToClientCheckBox.Checked == true && ID_Client_label.Text != "0" && setCarToClient.Count == 1) // Ця умова не дає можливості записати автомобіль до не існуючого клієнта
            {
        ...
        private void ViewClientsWithVinCheckBox_CheckedChanged(object sender, EventArgs e)
        {
